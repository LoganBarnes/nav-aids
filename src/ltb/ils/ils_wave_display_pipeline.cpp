...
auto to_wave_form( IlsWaveForm const wave_form ) -> WaveForm
{
    switch ( wave_form )
    {
        case IlsWaveForm::Sbo:
            return WaveForm::Sbo;
        case IlsWaveForm::Csb:
            return WaveForm::Csb;
        case IlsWaveForm::Carrier:
            return WaveForm::Carrier;
        case IlsWaveForm::Combined:
        case IlsWaveForm::All:
            break;
    }
