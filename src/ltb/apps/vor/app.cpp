...
VorApp::VorApp( window::GlfwContext& glfw_context, window::GlfwWindow& glfw_window )
    : glfw_context_( glfw_context )
    , glfw_window_( glfw_window )
{
}

auto VorApp::initialize( ) -> utils::Result< exec::UpdateLoopStatus >
{
    if ( !this->is_initialized( ) )
    {

        LTB_CHECK( this->initialize_gpu( )
                       .and_then( &VorApp::initialize_presentation )
                       .and_then( &VorApp::initialize_camera )
                       .and_then( &VorApp::initialize_waves )
                       .and_then( &VorApp::initialize_display_pipeline )
                       .and_then( &VorApp::initialize_meshes ) );
...
auto VorApp::is_initialized( ) const -> bool
{
    return initialized_;
}

auto VorApp::fixed_step_update( exec::UpdateLoopStatus const& status ) -> exec::UpdateRequests
{
    utils::ignore( status );
    return { };
}

auto VorApp::frame_update( exec::UpdateLoopStatus const& status ) -> exec::UpdateRequests
{
    utils::ignore( status );
...
auto VorApp::configure_gui( ) -> void
{
...
auto VorApp::on_resize( glm::ivec2 const size ) -> utils::Result< void >
{
...
auto VorApp::clean_up( ) -> utils::Result< void >
{
...
auto VorApp::initialize_gpu( ) -> utils::Result< VorApp* >
{
...
auto VorApp::initialize_presentation( ) -> utils::Result< VorApp* >
{
...
auto VorApp::initialize_camera( ) -> utils::Result< VorApp* >
{
...
auto VorApp::initialize_waves( ) -> utils::Result< VorApp* >
{
...
auto VorApp::initialize_display_pipeline( ) -> utils::Result< VorApp* >
{
...
auto VorApp::initialize_meshes( ) -> utils::Result< VorApp* >
{
...
auto VorApp::compute( ) -> utils::Result< void >
{
...
auto VorApp::render( ) -> utils::Result< void >
{
    LTB_CHECK(
...
auto VorApp::update_camera_uniforms( vlk::objs::FrameInfo const& frame ) -> utils::Result< void >
{
...
auto VorApp::record_render_commands( vlk::objs::FrameInfo const& frame ) -> utils::Result< void >
{
...
auto VorApp::update_world_pos( glm::vec2 const world_pos ) -> void
{
